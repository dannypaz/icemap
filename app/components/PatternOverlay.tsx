...
const PATTERNS: Record<string, PatternConfig> = {
  ...
  "4-pass (1-hole)": {
    ...
    lanes: [
      {
        startFt: CENTER_FT + ONE_HOLE_FT - SCRAPER_WIDTH_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "down",
      }, // Pass 1: Left inside - DOWN
      {
        startFt: CENTER_FT - ONE_HOLE_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "up",
      }, // Pass 2: Right inside - UP
      {
        startFt: -EDGE_OVERLAP_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "down",
      }, // Pass 3: Left outside (3" over edge) - DOWN
      {
        startFt: SHEET_WIDTH_FT - SCRAPER_WIDTH_FT + EDGE_OVERLAP_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "up",
      }, // Pass 4: Right outside (3" over edge) - UP
    ],
  },
  "5-pass (2-hole)": {
    // Center first, then inside passes, then outside
    // Outside passes overlap 3" past sheet edge
    color: "rgba(150, 0, 255, 0.25)",
    borderColor: "rgba(150, 0, 255, 0.6)",
    hoverColor: "rgba(150, 0, 255, 0.45)",
    lanes: [
      {
      ...
      {
        startFt: CENTER_FT + TWO_HOLE_FT - SCRAPER_WIDTH_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "up",
      }, // Pass 2: Left inside - UP
      {
        startFt: CENTER_FT - TWO_HOLE_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "down",
      }, // Pass 3: Right inside - DOWN
      { startFt: -EDGE_OVERLAP_FT, widthFt: SCRAPER_WIDTH_FT, direction: "up" }, // Pass 4: Left outside (3" over edge) - UP
      {
        startFt: SHEET_WIDTH_FT - SCRAPER_WIDTH_FT + EDGE_OVERLAP_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "down",
      }, // Pass 5: Right outside (3" over edge) - DOWN
    ],
  },
  "6-pass (2-hole)": {
    ...
    color: "rgba(220, 50, 100, 0.25)",
    borderColor: "rgba(220, 50, 100, 0.6)",
    hoverColor: "rgba(220, 50, 100, 0.45)",
    lanes: [
      {
        startFt: CENTER_FT + TWO_HALF_HOLE_FT - SCRAPER_WIDTH_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "down",
      }, // Pass 1: Left innermost (12" past center) - DOWN
      {
        startFt: CENTER_FT - TWO_HALF_HOLE_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "up",
      }, // Pass 2: Right innermost (12" past center) - UP
      {
        startFt: CENTER_FT + TWO_HOLE_FT - SCRAPER_WIDTH_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "down",
      }, // Pass 3: Left inside (8" past center) - DOWN
      {
        startFt: CENTER_FT - TWO_HOLE_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "up",
      }, // Pass 4: Right inside (8" past center) - UP
      {
        startFt: -EDGE_OVERLAP_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "down",
      }, // Pass 5: Left outside (3" over edge) - DOWN
      {
        startFt: SHEET_WIDTH_FT - SCRAPER_WIDTH_FT + EDGE_OVERLAP_FT,
        widthFt: SCRAPER_WIDTH_FT,
        direction: "up",
      }, // Pass 6: Right outside (3" over edge) - UP
    ],
  },
};
